...
public class Servicios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(21, 57, 73));
        ...
        jPanelOpciones.setBackground(new java.awt.Color(57, 180, 173));
        ...
        lblSaldo.setFont(new java.awt.Font("Roboto Medium", 0, 14)); // NOI18N
        ...
        jLabel3.setText("Seleccione el servicio a pagar:");

        cbServicios.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        cbServicios.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar", "Luz", "Agua", "Gas" }));
        ...
        jLabel4.setText("Ingrese el valor de su recibo:");

        lblMensaje.setFont(new java.awt.Font("Roboto Medium", 0, 13)); // NOI18N
        ...
        lblPanel.setFont(new java.awt.Font("Roboto Medium", 0, 20)); // NOI18N
        lblPanel.setForeground(new java.awt.Color(0, 0, 0));
        lblPanel.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblPanel.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanelOpcionesLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelOpcionesLayout.createSequentialGroup()
                .addGroup(jPanelOpcionesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelOpcionesLayout.createSequentialGroup()
                        .addGap(157, 157, 157)
                        .addComponent(lblPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanelOpcionesLayout.setVerticalGroup(
            ...
            .addGroup(jPanelOpcionesLayout.createSequentialGroup()
                ...
                .addGap(3, 3, 3)
                .addComponent(lblPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(lblMensaje, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(11, Short.MAX_VALUE))
        );

        jPanel5.setBackground(new java.awt.Color(21, 57, 73));
    ...
    private void btnClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearActionPerformed
        // Boton de CLEAR / Borrar
        this.lblPanel.setText("");
        this.lblMensaje.setText("");
    }//GEN-LAST:event_btnClearActionPerformed

    private void btnEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterActionPerformed
        // Boton de ENTER
        String ValorServicio = lblPanel.getText();
        this.lblMensaje.setText("Los " + ValorServicio + " pesos del valor de su servicio, fueron pagados exitosamente");
    }//GEN-LAST:event_btnEnterActionPerformed

    private void btnSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalirActionPerformed
        // Boton de regresar
        Extra Reinicio = new Extra();
    ...
    private void btn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn3ActionPerformed
        // Boton de 3
        this.lblPanel.setText(this.lblPanel.getText() + "3");
    }//GEN-LAST:event_btn3ActionPerformed

    private void btn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn2ActionPerformed
        // Boton de 2
        this.lblPanel.setText(this.lblPanel.getText() + "2");
    }//GEN-LAST:event_btn2ActionPerformed

    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        // Boton de 1
        this.lblPanel.setText(this.lblPanel.getText() + "1");
    }//GEN-LAST:event_btn1ActionPerformed

    private void btn0ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn0ActionPerformed
        // Boton de 0
        this.lblPanel.setText(this.lblPanel.getText() + "0");
    }//GEN-LAST:event_btn0ActionPerformed

    private void btn9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn9ActionPerformed
        // Boton de 9
        this.lblPanel.setText(this.lblPanel.getText() + "9");
    }//GEN-LAST:event_btn9ActionPerformed

    private void btn8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn8ActionPerformed
        // Boton de 8
        this.lblPanel.setText(this.lblPanel.getText() + "8");
    }//GEN-LAST:event_btn8ActionPerformed

    private void btn7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn7ActionPerformed
        // Boton de 7
        this.lblPanel.setText(this.lblPanel.getText() + "7");
    }//GEN-LAST:event_btn7ActionPerformed

    private void btn6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn6ActionPerformed
        // Boton de 6
        this.lblPanel.setText(this.lblPanel.getText() + "6");
    }//GEN-LAST:event_btn6ActionPerformed

    private void btn5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn5ActionPerformed
        // Boton de 5
        this.lblPanel.setText(this.lblPanel.getText() + "5");
    }//GEN-LAST:event_btn5ActionPerformed

    private void btn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn4ActionPerformed
        // Boton de 4
        this.lblPanel.setText(this.lblPanel.getText() + "4");
