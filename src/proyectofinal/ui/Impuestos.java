...
public class Impuestos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Seleccione el impuesto a pagar:");

        cbServicios.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        cbServicios.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar", "Renta", "Industria y comercio", "Riqueza o patrimonio", "Predial", "De vehículos" }));
        ...
        jLabel4.setText("Ingrese el valor del impuesto:");
    ...
    private void btnEnterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnterActionPerformed
        // Boton de ENTER
        String ValorImpuesto = lblPanel.getText();
        this.lblMensaje.setText("Su impuesto por " + ValorImpuesto + " pesos, fue pagado exitosamente");
